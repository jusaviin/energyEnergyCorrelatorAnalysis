...
public:
  ...
  enum enumUncertaintySources{kJetEnergyResolution, kJetEnergyScale, kUnfoldingTruth, kTrackSelection, kSingleTrackEfficiency, kTrackPairEfficiency, kBackgroundSubtraction, kCentralityShift, kMonteCarloClosure, kAll, knUncertaintySources};
...
private:
  ...
  TString fSystematicUncertaintyName[knUncertaintySources] = {"jetEnergyResolution", "jetEnergyCorrection", "unfoldingTruth", "trackSelection", "trackEfficiency", "trackPairEfficiency", "backgroundSubtraction", "centralityShift", "monteCarloClosure", "all"};
  TString fSystematicUncertaintyLegendName[knUncertaintySources] = {"Jet energy resolution", "Jet energy scale", "Unfolding prior shape", "Track selection", "Single track efficiency", "Track pair efficiency", "Background subtraction", "Centrality shift", "MC closure", "all"};
  TString fUncertaintyAxisName[knUncertaintySources] = {"JER", "JEC", "unfold truth", "track selection", "track eff", "pair eff", "bg sub", "cent shift", "MC closure", "all"};

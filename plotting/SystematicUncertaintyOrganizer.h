...
public:
  ...
  enum enumUncertaintySources{kJetEnergyResolution, kJetEnergyScale, kUnfoldingTruth, kTrackEfficiency, kTracPairEfficiency, kBackgroundSubtraction, kAll, knUncertaintySources};
...
private:
  ...
  TString fSystematicUncertaintyName[knUncertaintySources] = {"jetEnergyResolution", "jetEnergyCorrection", "unfoldingTruth", "trackEfficiency", "trackPairEfficeincy", "backgroundSubtraction", "all"};
  TString fUncertaintyAxisName[knUncertaintySources] = {"JER", "JEC", "unfold truth", "track eff", "pair eff", "bg sub" ,"all"};

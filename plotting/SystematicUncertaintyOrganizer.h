...
public:
  ...
  enum enumUncertaintySources{kJetEnergyResolution, kJetEnergyScale, kUnfoldingTruth, kUnfoldingIterations, kTrackSelection, kSingleTrackEfficiency, kTrackPairEfficiency, kBackgroundSubtraction, kSignalToBackgroundRatio, kCentralityShift, kMonteCarloStatistics, kMonteCarloNonClosure, kAll, knUncertaintySources};
...
private:
  ...
  TString fSystematicUncertaintyName[knUncertaintySources] = {"jetEnergyResolution", "jetEnergyCorrection", "unfoldingTruth", "unfoldingIterations", "trackSelection", "trackEfficiency", "trackPairEfficiency", "backgroundSubtraction", "signalToBackgroundRatio", "centralityShift", "monteCarloStatistics", "monteCarloNonClosure", "all"};
  TString fSystematicUncertaintyLegendName[knUncertaintySources] = {"Jet energy resolution", "Jet energy scale", "Unfolding prior shape", "Unfolding iterations", "Track selection", "Single track efficiency", "Track pair efficiency", "Background subtraction", "Signal-to-bg ratio", "Centrality shift", "MC unfolding stats", "MC non-closure", "all"};
  TString fUncertaintyAxisName[knUncertaintySources] = {"JER", "JEC", "unfold truth", "unfold iter", "track selection", "track eff", "pair eff", "bg sub", "sig-to-bg ratio" "cent shift", "unfold stats", "MC non-closure", "all"};
